...
CMDPRO_STATE_DIR = PROJECT_ROOT / "desktop_state" / "cmdpro"
RUNS_STATE_PATH = CMDPRO_STATE_DIR / "runs.json"
RUN_LOG_DIR = PROJECT_ROOT / "desktop_state" / "logs"


def ensure_cmdpro_state() -> None:
    CMDPRO_STATE_DIR.mkdir(parents=True, exist_ok=True)
