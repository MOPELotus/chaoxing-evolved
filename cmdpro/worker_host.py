...
from cmdpro.state import ensure_cmdpro_state, update_run_record


def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run a profile inside the command line Pro host process.")
